const CACHE = "ecommerce-helper-v2.0.1";
const ASSETS = ["./", "./index.html", "./styles.css?v=2.0.1", "./app.js?v=2.0.1", "./calculators.js?v=2.0.1", "./manifest.webmanifest", "./icon.svg", "./icon-192.png", "./icon-512.png"];
